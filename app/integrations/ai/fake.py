        ...
        "candidates": [
            {
                ...
                "domain": "ecopack-retail.example",
                "source_url": "https://ecopack-retail.example",
                "country": "United States",
                "buyer_type": "Importer",
                ...
                "fit_score": 92,
                "confidence_score": 12,
                "match_reason": "Snippet suggests an importer reviewing sustainable packaging.",
                "risk_reason": "Unverified search snippet; confirm product category manually.",
                "next_action": "research_next",
                "sanitized_snippet": (
                    "Importer profile with sustainable packaging category signals."
                ),
                "scoring_v2": {
                    "buyer_score": 86,
                    ...
                    "directory_risk_score": 5,
                    "marketplace_risk_score": 0,
                    "safety_risk_score": 0,
                    "positive_signals": ["importer", "official company site", "product fit"],
                    "risk_flags": ["unverified"],
                    "classification_v2": "strong_buyer",
                    "score_band": "high",
                    "recommended_action": "research_next",
                },
            },
            {
                "source_item_id": "item_002",
                "company_name": "Green Mailer GmbH",
                "domain": "greenmailer.example",
                "source_url": "https://greenmailer.example",
                "country": "Germany",
                "buyer_type": "Distributor",
                "classification": "buyer",
                "product_fit": "medium",
                ...
                "match_reason": "Pasted text indicates a distributor for mailer packaging.",
                "risk_reason": "Company profile is unverified and needs manual review.",
                "next_action": "review_first",
                "sanitized_snippet": "Distributor profile mentioning mailer packaging needs.",
                "scoring_v2": {
                    "buyer_score": 74,
                    "product_fit_score": 72,
                    "confidence_score": 76,
                    "supplier_risk_score": 10,
                    "directory_risk_score": 8,
                    "marketplace_risk_score": 0,
                    "safety_risk_score": 0,
                    "positive_signals": ["distributor", "Germany", "mailer packaging"],
                    "risk_flags": ["company profile only"],
                    "classification_v2": "likely_buyer",
                    "score_band": "medium",
            ...
            },
            {
                ...
                "company_name": "Custom Brand Packaging Ltd",
                "domain": "custombrandpackaging.example",
                "source_url": "https://custombrandpackaging.example",
                ...
                "confidence_score": 14,
                "match_reason": (
                    "Manual list entry looks like a packaging brand but evidence is limited."
                ),
                "risk_reason": "Thin source text; manually confirm buyer role and website.",
                "next_action": "review",
                "sanitized_snippet": "Importer name and country only.",
                "scoring_v2": {
                    "buyer_score": 56,
                    "product_fit_score": 58,
                    "confidence_score": 62,
                    "supplier_risk_score": 10,
                    "directory_risk_score": 10,
                    "marketplace_risk_score": 0,
                    "safety_risk_score": 0,
                    "positive_signals": ["private label brand", "packaging name"],
                    "risk_flags": ["thin source"],
                    "classification_v2": "maybe_buyer",
                    "score_band": "medium",
                    "recommended_action": "review_first",
                },
            },
            {
                "source_item_id": "item_004",
                "company_name": "Shenzhen Packaging Factory",
                "domain": "szpackagingfactory.example",
                "source_url": "https://szpackagingfactory.example",
                "country": "China",
                "buyer_type": "Factory",
                ...
                "fit_score": 70,
                "confidence_score": 70,
                "match_reason": "Factory wording indicates seller-side supplier risk.",
                "risk_reason": "Manufacturer/factory signal dominates.",
                "next_action": "discard",
                "sanitized_snippet": "Packaging manufacturer and factory profile.",
                "scoring_v2": {
                    "buyer_score": 20,
                    ...
                    "marketplace_risk_score": 0,
                    "safety_risk_score": 0,
                    "positive_signals": ["product category"],
                    "risk_flags": ["factory", "manufacturer"],
                    "classification_v2": "supplier_risk",
                    "score_band": "reject",
                    "recommended_action": "discard",
                },
            },
            {
                "source_item_id": "item_005",
                "company_name": "Global Packaging Directory",
                "domain": "packaging-directory.example",
                "source_url": "https://packaging-directory.example",
                "country": "",
                "buyer_type": "Directory",
                "classification": "directory",
                "product_fit": "low",
                "source_quality": "directory",
                "fit_score": 20,
                "confidence_score": 60,
                "match_reason": "Directory page, not a company buyer.",
                "risk_reason": "Directory/listing source should not be saved as a buyer.",
                "next_action": "discard",
                "sanitized_snippet": "Global packaging supplier directory.",
                "scoring_v2": {
                    "buyer_score": 10,
                    "product_fit_score": 20,
                    "confidence_score": 55,
                    "supplier_risk_score": 20,
                    "directory_risk_score": 90,
                    "marketplace_risk_score": 0,
                    "safety_risk_score": 0,
                    "positive_signals": [],
                    "risk_flags": ["directory"],
                    "classification_v2": "directory_risk",
                    "score_band": "reject",
                    "recommended_action": "discard",
                },
            },
            {
                "source_item_id": "item_006",
                "company_name": "Amazon marketplace result",
                "domain": "amazon.example",
                "source_url": "https://amazon.example/packaging",
                "country": "",
                "buyer_type": "Marketplace",
                "classification": "marketplace",
                "product_fit": "low",
                "source_quality": "marketplace",
                "fit_score": 15,
                "confidence_score": 70,
                "match_reason": "Marketplace listing, not a buyer company.",
                "risk_reason": "Marketplace page should be discarded.",
                "next_action": "discard",
                "sanitized_snippet": "Marketplace product listing.",
                "scoring_v2": {
                    "buyer_score": 5,
                    ...
                    "supplier_risk_score": 10,
                    "directory_risk_score": 10,
                    "marketplace_risk_score": 90,
                    "safety_risk_score": 0,
                    "positive_signals": [],
                    "risk_flags": ["marketplace"],
                    "classification_v2": "marketplace_risk",
                    "score_band": "reject",
                    "recommended_action": "discard",
                },
            },
