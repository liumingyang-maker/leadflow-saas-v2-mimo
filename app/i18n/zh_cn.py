...
_BASE_TRANSLATIONS = {
    ...
    "AI detected product family": "AI 识别的产品类型",
    ...
    "Credits": "额度",
    "Credits used": "已用额度",
    "Current product family": "当前产品类型",
    "Current product profile has changed. Please regenerate the AI search strategy.": (
        "当前产品画像已变化，请重新生成 AI 搜索策略。"
    ),
    "CSV import": "CSV 导入",
    "Customs data": "海关数据",
